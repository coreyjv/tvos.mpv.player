...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=x86_64 --cc='xcrun -sdk appletvsimulator clang' --as='xcrun -sdk appletvsimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-indev=avfoundation --disable-doc --enable-pic --disable-shared --enable-static --enable-gpl --enable-videotoolbox --enable-avresample --extra-cflags='-arch x86_64 -mtvos-simulator-version-min=10.2' --extra-ldflags='-arch x86_64 -mtvos-simulator-version-min=10.2' --prefix=/Users/corey/dev/tvOSMediaPlayer/contrib/FFmpeg-tvOS/thin/x86_64
...
CXX=g++
AS=xcrun -sdk appletvsimulator clang
OBJCC=xcrun -sdk appletvsimulator clang
LD=xcrun -sdk appletvsimulator clang
DEPCC=xcrun -sdk appletvsimulator clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=xcrun -sdk appletvsimulator clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=yasm
DEPX86ASM=yasm
...
CFLAGS=  -arch x86_64 -mtvos-simulator-version-min=10.2 -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch x86_64 -mtvos-simulator-version-min=10.2 -fPIC -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=xcrun -sdk appletvsimulator clang
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mtvos-simulator-version-min=10.2  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
