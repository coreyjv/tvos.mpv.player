...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk appletvos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk appletvos clang' --enable-cross-compile --disable-debug --disable-programs --disable-indev=avfoundation --disable-doc --enable-pic --disable-shared --enable-static --enable-gpl --enable-videotoolbox --enable-avresample --extra-cflags='-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode' --extra-ldflags='-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode' --prefix=/Users/corey/dev/tvOSMediaPlayer/contrib/FFmpeg-tvOS/thin/arm64
prefix=/Users/corey/dev/tvOSMediaPlayer/contrib/FFmpeg-tvOS/thin/arm64
...
SRC_PATH=/Users/corey/dev/tvOSMediaPlayer/contrib/FFmpeg
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple LLVM version 9.1.0 (clang-902.0.39.1)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
CC=xcrun -sdk appletvos clang
CXX=g++
AS=gas-preprocessor.pl -arch aarch64 -- xcrun -sdk appletvos clang
OBJCC=xcrun -sdk appletvos clang
LD=xcrun -sdk appletvos clang
DEPCC=xcrun -sdk appletvos clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl -arch aarch64 -- xcrun -sdk appletvos clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CFLAGS=  -arch arm64 -mtvos-version-min=10.2 -fembed-bitcode -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -mtvos-version-min=10.2 -fembed-bitcode -fPIC -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=xcrun -sdk appletvos clang
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mtvos-version-min=10.2 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
