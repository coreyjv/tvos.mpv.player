...
#define CONFIGURATION "./waf configure --disable-cplayer --disable-lcms2 --disable-lua --disable-libass --enable-libmpv-static --enable-ios-gl --enable-gl --out=/Users/corey/dev/tvOSMediaPlayer/contrib/mpv-tvOS/scratch/x86_64 --prefix=/Users/corey/dev/tvOSMediaPlayer/contrib/mpv-tvOS/thin/x86_64"
#define MPV_CONFDIR "/Users/corey/dev/tvOSMediaPlayer/contrib/mpv-tvOS/thin/x86_64/etc/mpv"
#define FULLCONFIG "asm atomics audiounit bsd-fstatfs build-date cplugins cuda-hwaccel debug-build drmprime dummy-osd encoding fchmod ffmpeg gl glob glob-posix gnuc gpl iconv ios-gl libaf libav-any libavcodec libavdevice libdl libm libmpv-static optimize osx-thread-name plain-gl posix posix-or-mingw pthreads stdatomic videotoolbox-hwaccel zlib"
